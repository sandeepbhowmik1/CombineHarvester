...
int main(int argc, char** argv) {
  ...
  config.add_options()
    ("input_file,i", po::value<string>(&input_file)->default_value("Tallinn/ttH_2lss_2tau_2016Jul16_Tight.input.root"))
    ("output_file,o", po::value<string>(&output_file)->default_value("ttH_2lss_2tau.root"))
  ...
  string aux_shapes = "/home/sbhowmik/ttHAnalysis_171018/2016/2017Oct04/datacards/2lss_2tau/";
